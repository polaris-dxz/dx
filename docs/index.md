...
1. **[指南总览](./guide/)** - 推荐阅读顺序与章节清单
2. **[环境安装](./guide/environment-setup)** - 系统与终端基础（Xcode CLT、Homebrew 等）
3. **[Shell 和编辑器](./guide/shell-editor-setup)** - 终端和编辑器配置
4. **[编程语言环境](./guide/language-environments)** - 按项目需要选择语言环境
5. **[开发工具](./guide/development-tools)** - 必备开发软件
