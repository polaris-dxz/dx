...
1. **[指南总览](./guide/)** — 路线图与清单  
2. **[环境安装](./guide/environment-setup)** — 系统与终端（再按 macOS / Linux / Windows 分册操作）  
3. **[开发工具](./guide/development-tools)** — 必备软件  
4. **[Shell 和编辑器](./guide/shell-editor-setup)** — 终端与编辑器增强  
5. **[环境变量](./guide/environment-variables)** — `PATH`、Shell 与项目 `.env`  
6. **[浏览器插件](./guide/browser-extensions)** — 上网与开发辅助  
7. **[Git](./guide/git)** 与 **[SSH](./guide/ssh-setup)** — 版本管理与远程仓库  
8. **编程语言** — 按需（如 [Node.js](./guide/nodejs-environment)、[Python](./guide/python-environment) 等）  
9. **[问题排查](./troubleshooting)** — 异常时查阅
